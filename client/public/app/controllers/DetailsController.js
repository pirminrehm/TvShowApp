...
app.controller('DetailController', ['$scope','$location','SeriesService','$routeParams','UserService', function($scope,$location, SeriesService, $routeParams, UserService){
	...
	// function progressBarUpdate (card){
